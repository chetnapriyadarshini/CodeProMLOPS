...
ROOT_FOLDER = "/home/"
ASSIGNMENT_FOLDER="/airflow/dags/lead_scoring_data_pipeline/"
DB_PATH = ROOT_FOLDER+ASSIGNMENT_FOLDER
MAPPING_FOLDER=ROOT_FOLDER+ASSIGNMENT_FOLDER+"mapping/"
DB_FILE_NAME = 'lead_scoring_data_cleaning.db'
UNIT_TEST_DB_FILE_NAME = 'unit_test_cases.db'
DATA_DIRECTORY = ROOT_FOLDER+ASSIGNMENT_FOLDER+'data/'
DATA = "leadscoring_inference.csv"
...
INTERACTION_MAPPING = MAPPING_FOLDER+'interaction_mapping.csv'
INDEX_COLUMNS_TRAINING = ['created_date', 'first_platform_c',
       'first_utm_medium_c', 'first_utm_source_c', 'total_leads_dropped', 'city_tier',
